...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!reacted) {
      await interaction.editReply({ content: 'Session started, but I could not add the startup reaction. Please make sure I have Add Reactions and Use External Emojis permissions.' });
      return;
    }
